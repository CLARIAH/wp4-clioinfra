...
# load the text for the about clio infra
GenericPath <- "/home/michalis/PhD/Clio Infra/Website/"

#load the foundation dates from CIA factbook
CIA <- read_excel('/home/michalis/PhD/Clio Infra/Website/CIA-Factbook-Countries with notes for their independence status.xls')
...
fileName <- '/home/michalis/PhD/Clio Infra/Website/CountryTemplateJSON.html'
fileName2 <- '/home/michalis/PhD/Clio Infra/Website/CountryTemplateNoMoreVisualsJSON.html'
    ...
    if (GlobalMetadata$DataPoints[which(GlobalMetadata$ClioInfraCountryName==CountryList[i])]>0){
      ...
      if (nrow(temp)>0){
        ...
        XxZzYyIndic1NoSpaceNoParXxZzYy <- paste(XxZzYyISO3XxZzYy,trimalls(gsub("[[:punct:]]", "", FilteredSelectedIndicators[2])),sep="_")
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyIndic1NoSpaceNoParXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
        ...
        if (length(FilteredSelectedIndicators) > 2){
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyIndic2NoSpaceNoParXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
        ...
        if (length(FilteredSelectedIndicators) > 3){
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyIndic3NoSpaceNoParXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
        ...
        if (length(FilteredSelectedIndicators) > 4){
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyIndic4NoSpaceNoParXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
        ...
        if (length(FilteredSelectedIndicators) > 5){
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyIndic5NoSpaceNoParXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
        ...
        if (length(FilteredSelectedIndicators)>=11){
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyMoreVisIndic1NoSpaceXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyMoreVisIndic2NoSpaceXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyMoreVisIndic3NoSpaceXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyMoreVisIndic4NoSpaceXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
          ...
          if (ExportJSON){
            jsondata <- toJSON(pdata)
            write(jsondata,paste0("/home/michalis/PhD/Clio Infra/Website/JSON/",XxZzYyMoreVisIndic5NoSpaceXxZzYy,".json"))
            rm(jsondata)
          }
          rm(temp2)
          
          setwd("/home/michalis/PhD/Clio Infra/Website")
